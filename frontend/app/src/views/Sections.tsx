...
import SectionBlog from './sections-sections/SectionBlog';
import SectionTeam from './sections-sections/SectionTeam';
import SectionProject from './sections-sections/SectionProject';
import SectionPricing from './sections-sections/SectionPricing';
import SectionTestimonials from './sections-sections/SectionTestimonials';
  ...
  React.useEffect(() => {
    ...
    const updateView = () => {
      ...
      for (let i = 0; i < contentSections.length; i++) {
        ...
        if (
          (contentSections[i] as HTMLElement).offsetTop - window.innerHeight / 2 <
            window.pageYOffset &&
          (contentSections[i] as HTMLElement).offsetTop +
