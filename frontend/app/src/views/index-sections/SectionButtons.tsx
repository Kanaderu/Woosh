...
type selectOptionsProps = {value:string, label:string, isDisabled?:boolean};
...
function SectionButtons() {
  ...
  const [defaultSelect, setDefaultSelect] = React.useState<selectOptionsProps|null>(null);
  const [successSelect, setSuccessSelect] = React.useState<selectOptionsProps|null>(null);
  const [dangerSelect, setDangerSelect] = React.useState<selectOptionsProps|null>(null);
  const [infoSelect, setInfoSelect] = React.useState<selectOptionsProps|null>(null);

  const handleTags = (regularTags: string[]) => {
              ...
              <Col md="3" sm="3">
                <FormGroup>
                  <Select
                    ...
                    name="defaultSelect"
                    value={defaultSelect}
                    //onChange={(value: selectOptionsProps): void => setDefaultSelect(value)}
              ...
              <Col md="3" sm="3">
                <FormGroup>
                  <Select
                    ...
                    name="successSelect"
                    value={successSelect}
                    //onChange={(value: selectOptionsProps): void => setSuccessSelect(value)}
                    options={selectOptions}
                    placeholder="CHOOSE CITY"
                  />
                </FormGroup>
              ...
              <Col md="3" sm="3">
                <FormGroup>
                  <Select
                    ...
                    name="dangerSelect"
                    value={dangerSelect}
                    //onChange={(value: selectOptionsProps): void => setDangerSelect(value)}
                    options={selectOptions}
                    placeholder="CHOOSE CITY"
                  />
                </FormGroup>
              ...
              <Col md="3" sm="3">
                <FormGroup>
                  <Select
                    ...
                    name="infoSelect"
                    value={infoSelect}
                    //onChange={(value: selectOptionsProps): void => setInfoSelect(value)}
                    options={selectOptions}
                    placeholder="CHOOSE CITY"
                  />
                </FormGroup>
