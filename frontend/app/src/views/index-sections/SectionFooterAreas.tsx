...
type optionsProps = { value:string, label:string };
            ...
            <Col className="ml-auto mr-auto" md="3" sm="3" xs="6">
              <FormGroup>
                <Select
                  ...
                  placeholder=""
                  //onChange={(value: optionsProps): void => setLanguageSelect(value)}
                  options={[
              ...
              <FormGroup>
                <Select
                  ...
                  value={curencySelect}
                  placeholder=""
                  //onChange={(value: optionsProps): void => setCurencySelect(value)}
                  options={[
                    { value: "ARS", label: "ARS" },
                    { value: "AUD", label: "AUD" },
                    { value: "BRL", label: "BRL" },
